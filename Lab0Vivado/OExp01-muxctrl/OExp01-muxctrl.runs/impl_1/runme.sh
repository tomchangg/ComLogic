...
HD_PWD='D:/NewwwwwW/ComputerOrg/Lab0Vivado/Lab0Vivado/OExp01-muxctrl/OExp01-muxctrl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OExp01_muxctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OExp01_muxctrl.tcl -notrace
