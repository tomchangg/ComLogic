...
module PipelineCPU(
    ...
    wire ALU_Src_B_ID , Branch_ID , BranchN_ID , MemRW_ID , Jump_ID , RegWrite_out_ID;
    ...
    wire ALUSrc_B_IDEX , Branch_IDEX , BranchN_IDEX , MemRW_IDEX , Jump_IDEX , RegWrite_IDEX;
    ...
    Ex_reg_Mem Ex_reg_Mem(
        ...
        .Junp_in_EXMem(Jump_IDEX), // ‘jump’ 好一个错误 
