...
#
# Script generated by Vivado on Wed Sep 18 19:57:27 +0800 2024
...
#
# Usage        : Seg7_Dev_0.sh
#                Seg7_Dev_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Seg7_Dev_0.sh [-reset_run]
#                Seg7_Dev_0.sh [-reset_log]
#                Seg7_Dev_0.sh [-help]
#
...
#                script (type 'Seg7_Dev_0.sh -help' for more information).
#
...
# script info
echo -e "Seg7_Dev_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Seg7_Dev_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.Seg7_Dev_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.Seg7_Dev_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Seg7_Dev_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: Seg7_Dev_0.sh [-step]\n\
Usage: Seg7_Dev_0.sh [-lib_map_path]\n\
Usage: Seg7_Dev_0.sh [-reset_run]\n\
Usage: Seg7_Dev_0.sh [-reset_log]\n\
Usage: Seg7_Dev_0.sh [-keep_index]\n\
