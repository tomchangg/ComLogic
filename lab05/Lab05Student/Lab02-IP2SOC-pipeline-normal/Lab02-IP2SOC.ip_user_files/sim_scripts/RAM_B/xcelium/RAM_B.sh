...
#
# Script generated by Vivado on Wed Nov 27 18:47:09 +0800 2024
...
# script info
echo -e "RAM_B.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.RAM_B xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.RAM_B -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log RAM_B_sc.so .tmp_log xcelium_lib waves.shm c.obj)
