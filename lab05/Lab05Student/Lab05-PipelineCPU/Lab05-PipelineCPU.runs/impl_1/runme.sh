...
HD_PWD='D:/NewwwwwW/ComputerOrg/lab05/Lab05Student/Lab05-PipelineCPU/Lab05-PipelineCPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PipelineCPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PipelineCPU.tcl -notrace
