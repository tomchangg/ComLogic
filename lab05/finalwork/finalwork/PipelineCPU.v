...
module PipelineCPU(
	...
	output wire [31:0] new_PC_out_EX //
    );
    ...
    wire ALU_Src_B_ID , Branch_ID , BranchN_ID , MemRW_ID , RegWrite_out_ID;
	...
	assign new_PC_out_EX = PC_out_IDEX;
