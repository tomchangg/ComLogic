...
(
    ...
    // initial begin
    //     $readmemh("tag_ram1.mem", cache_tag);
    // end

    initial begin
        cache_tag[0] = 26'b10000000000000000000001000;
        cache_tag[1] = 26'b10000000000000000000001001;
        cache_tag[2] = 26'b10000000000000000000001010;
        cache_tag[3] = 26'b11100000000000000000001011;  // valid but [LRU(old) + dirty]
    end
