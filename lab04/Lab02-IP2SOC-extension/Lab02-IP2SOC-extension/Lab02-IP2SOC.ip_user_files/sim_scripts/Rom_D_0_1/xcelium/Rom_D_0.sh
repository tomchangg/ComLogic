...
#
# Script generated by Vivado on Wed Nov 27 13:50:20 +0800 2024
...
#
# Usage        : Rom_D_0.sh
#                Rom_D_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Rom_D_0.sh [-reset_run]
#                Rom_D_0.sh [-reset_log]
#                Rom_D_0.sh [-help]
#
...
#                script (type 'Rom_D_0.sh -help' for more information).
#
...
# script info
echo -e "Rom_D_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Rom_D_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.Rom_D_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.Rom_D_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Rom_D_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: Rom_D_0.sh [-step]\n\
Usage: Rom_D_0.sh [-lib_map_path]\n\
Usage: Rom_D_0.sh [-reset_run]\n\
Usage: Rom_D_0.sh [-reset_log]\n\
Usage: Rom_D_0.sh [-keep_index]\n\
